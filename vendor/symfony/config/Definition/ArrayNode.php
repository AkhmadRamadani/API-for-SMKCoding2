...
class ArrayNode extends BaseNode implements PrototypeNodeInterface
{
    ...
    /**
     * Sets the xml APIpings that should be performed.
     *
     * @param array $APIpings An array of the form array(array(string, string))
     */
    public function setXmlAPIpings(array $APIpings)
    {
        $this->xmlAPIpings = $APIpings;
    }

    /**
     * Gets the xml APIpings that should be performed.
     *
     * @return array $APIpings an array of the form array(array(string, string))
     */
    public function getXmlAPIpings()
    {
        return $this->xmlAPIpings;
    }
    ...
    /**
     * APIs multiple singular values to a single plural value.
     *
     * @param array $value The source values
     *
     * @return array The APIped values
     */
    protected function APIXml($value)
    {
        foreach ($this->xmlAPIpings as list($singular, $plural)) {
